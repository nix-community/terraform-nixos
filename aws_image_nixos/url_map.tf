...
variable "url_map" {
  ...
  default = {
    ...
    "latest.ap-east-1.hvm-ebs"      = "ami-0d18fdd309cdefa86"
    "latest.ap-northeast-1.hvm-ebs" = "ami-093d9cc49c191eb6c"
    "latest.ap-northeast-2.hvm-ebs" = "ami-0087df91a7b6ebd45"
    "latest.ap-south-1.hvm-ebs"     = "ami-0a1a6b569af04af9d"
    "latest.ap-southeast-1.hvm-ebs" = "ami-0dbf353e168d155f7"
    "latest.ap-southeast-2.hvm-ebs" = "ami-04c0f3a75f63daddd"
    "latest.ca-central-1.hvm-ebs"   = "ami-02365684a173255c7"
    "latest.eu-central-1.hvm-ebs"   = "ami-0a1a94722dcbff94c"
    "latest.eu-north-1.hvm-ebs"     = "ami-02699abfacbb6464b"
    "latest.eu-west-1.hvm-ebs"      = "ami-02c34db5766cc7013"
    "latest.eu-west-2.hvm-ebs"      = "ami-0e32bd8c7853883f1"
    "latest.eu-west-3.hvm-ebs"      = "ami-061edb1356c1d69fd"
    "latest.sa-east-1.hvm-ebs"      = "ami-09859378158ae971d"
    "latest.us-east-1.hvm-ebs"      = "ami-0c5e7760748b74e85"
    "latest.us-east-2.hvm-ebs"      = "ami-030296bb256764655"
    "latest.us-west-1.hvm-ebs"      = "ami-050be818e0266b741"
    "latest.us-west-2.hvm-ebs"      = "ami-06562f78dca68eda2"
  }
