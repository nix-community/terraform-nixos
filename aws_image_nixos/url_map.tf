...
variable "url_map" {
  ...
  default = {
    ...
    "latest.ap-northeast-1.hvm-ebs" = "ami-0cdba8e998f076547"
    "latest.ap-northeast-2.hvm-ebs" = "ami-0400a698e6a9f4a15"
    "latest.ap-south-1.hvm-ebs" = "ami-0880a678d3f555313"
    "latest.ap-southeast-1.hvm-ebs" = "ami-0892c7e24ebf2194f"
    "latest.ap-southeast-2.hvm-ebs" = "ami-010730f36424b0a2c"
    "latest.ca-central-1.hvm-ebs" = "ami-04f66113f76198f6c"
    "latest.eu-central-1.hvm-ebs" = "ami-07c9b884e679df4f8"
    "latest.eu-west-1.hvm-ebs" = "ami-0f412186fb8a0ec97"
    "latest.eu-west-2.hvm-ebs" = "ami-0dada3805ce43c55e"
    "latest.eu-west-3.hvm-ebs" = "ami-074df85565f2e02e2"
    "latest.sa-east-1.hvm-ebs" = "ami-0e4a8a47fd6db6112"
    "latest.us-east-1.hvm-ebs" = "ami-009c9c3f1af480ff3"
    "latest.us-east-2.hvm-ebs" = "ami-08199961085ea8bc6"
    "latest.us-west-1.hvm-ebs" = "ami-07aa7f56d612ddd38"
    "latest.us-west-2.hvm-ebs" = "ami-01c84b7c368ac24d1"
  }
